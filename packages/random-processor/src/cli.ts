...
if (require.main === module) {
  const { RELAYER_API_KEY, RELAYER_API_SECRET }: any = process.env;
  const secrets: any = {
    ...
    ASYMETRIX_API_AUTH_KEY: process.env.ASYMETRIX_API_AUTH_KEY,
    ASYMETRIX_API_JWT_SECRET: process.env.ASYMETRIX_API_JWT_SECRET,
  };
